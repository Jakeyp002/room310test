(() => {
  ...
  document.documentElement.dataset.assignmentWorkspace = "v0.13";
...
Console.WriteLine($"Hello from {course}!");`
  ...
  panel.innerHTML = `
    <header class="assignment-workspace-header">
      ...
      <div class="assignment-workspace-header-actions"><span class="assignment-workspace-version">v0.13</span><button type="button" class="assignment-workspace-close" aria-label="Close assignment workspace">×</button></div>
    </header>
