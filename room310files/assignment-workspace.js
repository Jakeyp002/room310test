(() => {
  ...
  document.documentElement.dataset.assignmentWorkspace = "v0.14";
...
Console.WriteLine($"Hello from {course}!");`
  ...
  panel.innerHTML = `
    <header class="assignment-workspace-header">
      ...
      <div class="assignment-workspace-header-actions"><span class="assignment-workspace-version">v0.14</span><button type="button" class="assignment-workspace-close" aria-label="Close assignment workspace">×</button></div>
    </header>
