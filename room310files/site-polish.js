(() => {
  ...
  if (logo && !version) {
    ...
    version.textContent = "v1.5";
    version.setAttribute("aria-label", "Room310 version 1.5");
    logo.after(version);
  }
  ...
  const loadCourseLab = () => {
    ...
    script.src = "course-lab.js?v=1.5";
  ...
  const loadAssignmentWorkspace = () => {
    ...
    const script = document.createElement("script");
    script.src = "assignment-workspace.js?v=1.5";
    document.body.append(script);
  };
